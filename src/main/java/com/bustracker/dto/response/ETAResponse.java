...
/**
 * Response DTO containing the estimated time of arrival (ETA)
 * for a specific bus to reach a specific bus stop.
 *
 * <p>Includes both the bus and stop coordinates to enable the frontend
 * to draw route lines on the map.</p>
 */
